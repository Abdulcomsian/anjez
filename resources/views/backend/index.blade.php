        ...
        <div class="container section-1">
          <div class="text-container">
            ...
            <div class="button-section">
              <div class="button-1">
                <button class="signu-up" > <a href="./signup.html"> Sign Up </a>  </button>
              </div>
              <div class="button-2">
                <button class="signu-up"><a href="./student-content.html"> View Courses</a>  </button>
              </div>
            </div>
          </div>
        </div>
        ...
        <div class="section-4">
          <div class="container">
            <div class="section-4-main">
              <div class="section-left">
                <img
                  src="./assets/images/planning-schedule-time-management-with-stopwatch-man-with-tablet_108855-1986 1.png"
                />
              </div>
              <div class="section-right">
                <div class="text-line-1">
        ...
        <div class="section-5">
          <div class="container">
            <div class="section-5-main">
              ...
              <div class="section-right">
                <img
                  src="./assets/images/3d-illustration-pen-putting-blue-ticks-paper 1.png"
                />
              </div>
            </div>
          </div>
                ...
                <div class="card swiper-slide">
                  <div class="card-head">
                    <div class="profile-content">
                      <div>
                        <img
                          src="./assets/profile-images/profile1.jpg"
                          alt=""
                          class="card-img"
                        />
                      </div>
                ...
                <div class="card swiper-slide">
                  <div class="card-head">
                    <div class="profile-content">
                      <div>
                        <img
                          src="./assets/profile-images/profile2.jpg"
                          alt=""
                          class="card-img"
                        />
                      </div>
                ...
                <div class="card swiper-slide">
                  <div class="card-head">
                    <div class="profile-content">
                      <div>
                        <img
                          src="./assets/profile-images/profile3.jpg"
                          alt=""
                          class="card-img"
                        />
                      </div>
                ...
                <div class="card swiper-slide">
                  <div class="card-head">
                    <div class="profile-content">
                      <div>
                        <img
                          src="./assets/profile-images/profile4.jpg"
                          alt=""
                          class="card-img"
                        />
                      </div>
                ...
                <div class="card swiper-slide">
                  <div class="card-head">
                    <div class="profile-content">
                      <div>
                        <img
                          src="./assets/profile-images/profile5.jpg"
                          alt=""
                          class="card-img"
                        />
                      </div>
                ...
                <div class="card swiper-slide">
                  <div class="card-head">
                    <div class="profile-content">
                      <div>
                        <img
                          src="./assets/profile-images/profile6.jpg"
                          alt=""
                          class="card-img"
                        />
                      </div>
                ...
                <div class="card swiper-slide">
                  <div class="card-head">
                    <div class="profile-content">
                      <div>
                        <img
                          src="./assets/profile-images/profile7.jpg"
                          alt=""
                          class="card-img"
                        />
                      </div>
                ...
                <div class="card swiper-slide">
                  <div class="card-head">
                    <div class="profile-content">
                      <div>
                        <img
                          src="./assets/profile-images/profile8.jpg"
                          alt=""
                          class="card-img"
                        />
                      </div>
                ...
                <div class="card swiper-slide">
                  <div class="card-head">
                    <div class="profile-content">
                      <div>
                        <img
                          src="./assets/profile-images/profile9.jpg"
                          alt=""
                          class="card-img"
                        />
                      </div>
