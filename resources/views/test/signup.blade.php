              ...
              <div>
                <div class="text-container mt-3">
                  <div class="text-line-1 mt-5">
                    <span data-translate="get-started-with"> Get started with </span>  <span style="color: #7e5bf6;" data-translate="anjez">Anjez</span>
                  </div>
                ...
                <div class="form-container">
                  <form>
                    <div class="nav-div">
                      ...
                      <div>
                        <label for="lastname" class="form-label" data-translate="last-name"
                          >Last Name</label
                        >
                        <input
                          style="width: 100%"
                    ...
                    <div>
                      <label for="confirmpassword" class="form-label" data-translate="confirm-password"
