...
<head>
    ...
    <!-- <link rel="stylesheet" href="./assets/style/student-content-en.css" /> -->
    ...
    <link rel="preconnect" href="https://fonts.googleapis.com">
    <link rel="preconnect" href="https://fonts.gstatic.com" crossorigin>
    <link href="https://fonts.googleapis.com/css2?family=DM+Sans:wght@400;500;700&family=Inter:wght@200;400;500;600;700&family=Manrope:wght@400;500;600;700&family=Noto+Sans:wght@400;500;600;700;800&family=Nunito:wght@200;300;400;500;600;700&display=swap" rel="stylesheet">
                        ...
                        <ul class="nav nav-pills flex-column mb-sm-auto mb-0 align-items-center align-items-sm-start w-100 mt-3" id="menu">
                            <div class="one" onclick="dropOne()">
                                <li class="dropdown font-noto-sans  nav-item  w-100 px-lg-3 px-sm-0 mt-3 ms-3 " onclick="dropOne()">
                                    ...
                                    <a class="dropdown-toggle ms-2 " data-toggle="dropdown" href="#" onclick="dropOne()" data-translate="courses"> Courses <span class="caret"></span></a>
                                </li>
                            </div>
                            <!-- dropdown-one  -->
                            <div id="drop-one" onclick="dropTwo()">
                                <div class="d-flex ms-4 mt-3">
                                    ...
                                    <a class="dropdown-toggle ms-2 mt-2 subject" data-toggle="dropdown" href="#" onclick="bio()" data-translate="biology">
                            ...
                            <div id="drop-two">
                                <div class="two d-flex flex-column mt-3 pb-3">
                                    <a class=" ms-2 mt-3 main-topic" href="#" data-translate="main-topic"> Main Topic<span class="caret"></span></a>
                                    <a class="dropdown-toggle ms-2 mt-3 main-topic " data-toggle="dropdown" href="#" onclick="dropthree()" data-translate="main-topic"> Main Topic
                                        <span class="caret"></span>
                                    </a>
                                    <!-- dropdown three  -->
                                    <div id="drop-three" class="toggles">
                                        <div class="three d-flex flex-column">
                                            <a class=" ms-4 mt-3 px-2" id="sub" href="#" onclick="subTopic()" style=" width: 100%;" data-translate="sub-topic"> Sub Topic
                                                <span class="caret"></span></a>
                                            <a class=" ms-4 mt-3 px-2 " href="#" style=" width: 100%;" data-translate="sub-topic"> Sub Topic <span class="caret"></span></a>
                                        </div>
                                    </div>
                                    <a class=" ms-2 mt-3 main-topic" href="#" data-translate="main-topic"> Main Topic <span class="caret"></span></a>
                                    <a class=" ms-2 mt-3 main-topic" href="#" data-translate="main-topic"> Main Topic <span class="caret"></span></a>
                            ...
                            <div id="drop-one1">
                                <div class="d-flex ms-4 mt-3">
                                    ...
                                    <a class="dropdown-toggle ms-2 mt-2 subject" data-toggle="dropdown" href="#" data-translate="math">
                            ...
                            <div id="drop-one2">
                                <div class="d-flex ms-4 mt-3">
                                    ...
                                    <a class="dropdown-toggle ms-2 mt-2 subject" data-toggle="dropdown" href="#" data-translate="physics">
                            ...
                            <div id="drop-one3">
                                <div class="d-flex ms-4 mt-3">
                                    ...
                                    <a class="dropdown-toggle ms-2 mt-2 subject" data-toggle="dropdown" href="#" data-translate="chemistry">
                    ...
                    <div class="student-content">
                        <div class="row d-flex justify-content-between">
                            <div class="col  d-flex justify-content-start">
                                <div class="subject-heading" data-translate="biology"> Biology </div>
                            </div>
                        ...
                        <div class="row flex-column">
                            <div class="col-7 textss text-start ">
                                <span data-translate="Subscribe-now-to-unlock-a-world-of-knowledge-and-never-miss-out-on-our-latest-updates,-lessons,-and-exclusive-content.">Subscribe
                                    now to unlock a world of knowledge and never miss out
                                    on our latest updates, lessons, and exclusive content.</span>
                            </div>
                            <div class="col mt-3"> <button class="px-4" type="button"> <a href="/payment.html" data-translate="subscribe">
                                        Subscribe </a> </button></div>
                        </div>
                        <div class="contents px-4 mt-4 pt-1">
                            <div class="contents-heading d-flex justify-content-center mt-4 " data-translate="contents"> Contents </div>
                            <div class="row mt-4">
                                <div class="col py-2">
                    ...
                    <div class="lecture">
                        ...
                        <div class="row mt-4 justify-content-between">
                            ...
                            <div class="col-4 d-flex justify-content-end">
                                <button class="video-button-2" style="padding: 10px; border-radius: 8px;" data-toggle="modal" data-target="#exampleModal">Test Your
                                    Knowledge</button>
                            </div>
                        </div>
