                    ...
                    <div class="lecture">
                        ...
                        <div class="embed-responsive embed-responsive-21by9 mt-4" id="video-container">
                            <video id="myVideo" class="embed-responsive-item"
                                src="./assets/videos/THAILAND IN 30 SECONDS - CINEMATIC VIDEO- 4k.mp4" controls></video>
                        ...
                        <div class="row mt-4">
                            <div class="col">
                                <div class="dropdown">
                                    <button class="btn attach dropdown-toggle" type="button" id="dropdownMenuButton"
                                        ...
                                        <div class="row d-flex justify-content-center pb-5 mt-4">
                                            ...
                                            <div class="col-4">
                                                <button id="restartBtn2" style="display: none;"> <a
                                                    href="{{ url('/studentcontent') }}"> Back to Home</a> </button>
                                                <div id="score" style="display: none;"></div>
                                            </div>
                                        </div>
                                    </div>
