              ...
              <div class="button-line">
                <div class="button-1">
                  ...
                  <div class="sign-up" data-translate="subscribe-now">
                    <a class="text-decoration-none custom-button-2" href="#" style="color:#fff !important; background: #7e5bf6; border:1px solid #7e5bf6 !important; cursor: pointer;" data-translate='subscribe-now'>
                      {{ __('lang.section2.subscribe_now') }}
                    </a>
                  </div>
